...
$sql = "SELECT pid, project.eid, pname, duedate, subdate,  firstName, lastName, total FROM `project` , `employee`, `salary`  WHERE project.eid = $id ";
...
<?php
  $id = (isset($_GET['id']) ? $_GET['id'] : '');
  $pid = (isset($_GET['pid']) ? $_GET['pid'] : '');
  $sql1 = "SELECT pid, project.eid, project.pname, project.duedate, project.subdate, employee.firstName, employee.lastName,  salary.total FROM `project` , `employee`, `salary`  WHERE project.eid = $id AND project.pid = $pid AND project.eid =  salary.id = project.eid AND employee.id = project.eid ";
